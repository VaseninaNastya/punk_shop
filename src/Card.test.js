...
describe("src/components/Card", () => {
  describe("Card", () => {
    it("expected innerHTML in elements of DOM", () => {
      ...
      expect(container.querySelector("li:first-child").textContent).toBe(
        "Tagline: A Real Bitter Experience."
      );
      expect(container.querySelector("li:nth-child(2)").textContent).toBe(
        "First brewed: 09/2007"
      );
      expect(container.querySelector("li:nth-child(3)").textContent).toBe(
        "Volume: 20 litres"
      );
