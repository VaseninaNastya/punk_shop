...
const RegistrationPopupListItem = ({
  labelInnerText,
  inputId,
  errorMessage,
  emptyErrorMessage,
  ...
  const errorMessageClass = cl(s.errorMessage, {
    [s.errorMessage_hidden]: wrongValue === false,
  });

  const emptyErrorMessageClass = cl(s.errorMessage, {
    [s.errorMessage_hidden]: emptyInput === false,
  });
